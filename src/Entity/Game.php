...
class Game implements SlugInterface
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['game:item', 'review:collection:game'])]
    private ?int $id = null;

    #[ORM\Column(length: 255)]
    #[Groups(['game:collection', 'game:item', 'game:post', 'review:collection:game', 'UserOwnGame:item'])]
    ...
    #[ORM\Column(length: 255)]
    #[Groups('game:collection', 'UserOwnGame:item')]
